...
export default function Home({ addToCart, cartItems = [] }) {
  ...
  return (
    <div className="bg-[#FAF3E0] min-h-screen">
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 flex justify-between items-center bg-[#5C4033] p-5 shadow-md z-50">        <Link to="/">
      ...
      {/* Main Content */}
      <main className="flex flex-col justify-center items-center pb-20 mt-[100px]">
    <div className="text-center flex flex-col items-center justify-center">
      ...
      <p className="text-lg text-[#8B4513] mb-10">
        By Taqwa Rasheed, Fatimah Ansari and Arisha Rehan Chotani
      </p>
    </div>
