        ...
        {showForm && (
          <div className="mb-8 bg-white p-6 rounded shadow">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <label htmlFor="employee_name" className="block mb-1 font-medium text-gray-700">
                Employee Name:
              </label>
                <input
                  type="text"
              ...
              <label htmlFor="salary" className="block mb-1 font-medium text-gray-700">
                ...
                <div className="flex flex-col"> 
              <label htmlFor="hire_date" className="block mb-1 font-medium text-gray-700">
                Hire Date:
              </label>
                <input
                  type="date"
              ...
              <div className="flex flex-col"> 
              <label htmlFor="job_title" className="block mb-1 font-medium text-gray-700">
                Job Title:
              </label>
              <div className="grid grid-cols-2 gap-4">
                <input
              ...
              <div className="flex flex-col"> 
              <label htmlFor="admin_id" className="block mb-1 font-medium text-gray-700">
                Admin ID:
              </label>
                <input
                  type="number"
